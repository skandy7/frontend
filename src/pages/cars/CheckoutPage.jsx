...
const CheckoutPage = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            // Create order and await the result
            ...
            Swal.fire({
                ...
                // After successful order, navigate to the orders page
                navigate("/orders");
        ...
        <section>
            <div className="min-h-screen p-6 bg-gray-100 flex items-center justify-center">
                <div className="container max-w-screen-lg mx-auto">
                    <div>
                        <div>
                            <h2 className="font-semibold text-xl text-gray-600 mb-2">Confirm your booking</h2>
                            <p className="text-gray-500 mb-2">Consultation fee  ₹{totalPrice}</p>
                                        ...
                                        <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                            ...
                                            <div className="md:col-span-5 text-right">
                                                <div className="inline-flex items-end">
                                                    <button
                                                        disabled={!isChecked}
                                                        className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Consult and Order Now</button>
                                                </div>
                                            </div>
